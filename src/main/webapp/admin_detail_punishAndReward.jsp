		...
		<ul class="nav navbar-nav">
	        ...
	        <li class="dropdown active">
		        ...
		        <ul class="dropdown-menu">
			        <li><a href="#">学籍信息</a></li>
					<li><a href="#">联系信息</a></li>
		           	<li class="active"><a href="${pageContext.request.contextPath}/admin_detail_punishAndReward.jsp">奖罚信息</a></li>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class=" col-md-8 col-md-offset-1">
			<div class="panel panel-info">
			    <div class="panel-heading ">
			        <h3 class="panel-title text-center">奖罚信息</h3>
			    </div>
			    <div class="panel-body">
					<div class="table-responsive">
						<table class="table table-bordered">
							<thead>								
								...
								<tr>
									<td  colspan="5" >1：于2022-01-01 因为----原因----  荣获（处罚） ----内容------</td>
								</tr>
			
								<tr>
									<td  colspan="5" >2：于2022-01-01 因为----原因----  荣获（处罚） ----内容------</td>
								</tr>
			
								<tr>
									<td  colspan="5" >3：于2022-01-01 因为----原因----  荣获（处罚） ----内容------</td>
								</tr>
							</thead>
						</table>
					</div>  
